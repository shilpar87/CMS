...
public class ParseX509Certificate
{
  ...
  { //s="" ;
    ...
    rawCert = s;
    System.out.println("rawCert in ParseX509Certificate -------------- > "+rawCert);
    x509cert = null;
    subject = null;
    subjectTable = null;
    issuer = null;
...
//    base64inputstream.read(abyte0, 0, abyte0.length);
  ...
  public ParseX509Certificate(String aliasName,KeyStore keyStore)throws CertificateException, IOException,Exception{
      x509cert = null;
    	subject = null;
    	subjectTable = null;
    	issuer = null;
  ...
  {
    //ParseX509Certificate parsex509certificate = new ParseX509Certificate("C:\\csr.der");
    //ParseX509Certificate parsex509certificate = new ParseX509Certificate("") ;
      ParseX509Certificate parsex509certificate = new ParseX509Certificate("");      
