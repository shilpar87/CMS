...
document.forms[0].action = "CMSAction.do?methodToCall=insertCertData";	  	
...
//  alert(document.forms[0].appName.value);
	document.forms[0].appName.value;
	document.forms[0].action="CMSAction.do?methodToCall=getAcroNym";
	document.forms[0].submit();
	return true;
}
...
<body>
	...
	<html:form action="/CMSToolAction.do?methodToCall=getCertUserDetails"> 
	<table border="0" align="center" cellpadding="2" cellspacing="0" width="40%" bgcolor="336699" >
	<tr>
	...
	<tr bgcolor="f1f1f1">
		...
		<td><html:select name="CMSFormBean" property="appName" size="1" style="font-size: 0.80em;" onchange="getAcroNym()" >
	...
	<table align="center">
	<tr>
		<td align="center"><input type="submit" value="Add"  style="font-size: 1.05em; padding: 0.05em;" name="Add" value ="Submit" onclick='validate()'></td>
		<td> &nbsp</td>
		<td align="center"><html:reset value="Reset" style="font-size: 1.05em; padding: 0.05em;" onclick='reset()'></html:reset></td>
	</tr>
	</table>
