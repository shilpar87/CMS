...
<html:html>
	...
	<html:form action="CMSAction.do?methodToCall=certInAccount">
	<head>
	</head>
	<body>
	...
	<tr><tr><td align="center"><input type="button"  value="Back" style="font-size: 1.05em; padding: 0.03em;" name="Back" onclick="history.go(-1)"></td></tr>
	</table>
	</body>
	</html:form>
</html:html>