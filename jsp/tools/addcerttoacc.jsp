...
<html:form  action="/CMSToolAction.do?methodToCall=getCertDetails" enctype="multipart/form-data"> 
...
<%if(request.getAttribute("error")!=null){%>
   ...
   <table>
	<tr><td>&nbsp</td>
		<td><TEXTAREA title=Certificate style="WIDTH: 445px; HEIGHT: 180px"  name="crttest" id="crttest" rows=11 cols=46 onclick="setDefaultTotxt('text')"></TEXTAREA></td>
	...
	<tr>
		...
		<td> <html:submit value="Add" style="font-size: 1.05em; padding: 0.05em;"></html:submit></td>
