...
<html>
 ...
 <BODY>
 <html:form action="/CMSToolAction.do?methodToCall=creatNewCsr">
 <b><font size="3" color="336699">Certificate Signing Request(CSR) of the Given Certificate </font></b>
  <table><tr><td>
   <%ArrayList tempcsr=new ArrayList();
 if(session.getAttribute("tempNewcsr")!=null)
 {tempcsr=(ArrayList)session.getAttribute("tempNewcsr");
