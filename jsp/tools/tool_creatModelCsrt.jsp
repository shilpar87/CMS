...
<html:form  action="/CMSToolAction.do?methodToCall=creatNewCsrt" enctype="multipart/form-data"> 
...
<%if(request.getAttribute("error")!=null){%>
   <tr>
	...
	<tr>
		<td align="center" valign="top" ><b><font size="3" color="FFFFFF"> CREATE CERTIFICATE FROM MODEL CERTIFICATE </font> </b></td> 
    </tr>
 	</table><br>
