...
var menu9=new Array()
menu9[0]='<table width="300" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999"><tr><td bgcolor="#FFFFFF" class="Bluetxt" style="padding-left:10px;padding-right:10px;padding-top:5px;padding-bottom:5px"><div align="justify"><b>Validity</b><br><br>The validity period of the certificate</div></td></tr></table>'
...
<body >
	...
	<tr bgcolor="DFECFF" >  
		...
		<td align="left" width="" height="30"> 
			<select name="sigAlgorithm" size="1" style="font-size: 1.05em;" onmouseover = "dropdownmenu(this, event, menu8, '200px')" >
	...
	<tr bgcolor="D2E8FF" >  
		...
		<td align="left" width="" height="30" > 
			<select name="cert_validity" size="1" style="font-size: 1.05em;" onmouseover = "dropdownmenu(this, event, menu9, '200px')">
			<option value="null" selected >Select...</option>
	...
	<tr bgcolor="DFECFF">
		...
		<td align="left" width="" height="30"> <input type="text" class="text" onmouseover = "dropdownmenu(this, event, menu1, '200px')"  name="comName" value='Qwest Microsoft .NET Services'> </td>
	</tr>
	<tr bgcolor="D2E8FF">
		<td align="right" ><font size="2" color=" 004488" >Organizational Unit (OU) : </td>
		<td align="left" width="" height="30"> <input type="text" class="text" onmouseover = "dropdownmenu(this, event, menu2, '200px')" wrap="off"  name="orgUnit" value='IPKI Infrastructure Team'> </td>
	</tr>
	<tr bgcolor="DFECFF">
		<td align="right" ><font size="2" color=" 004488" >Organizational Name (ON) : </td>
		<td align="left" width="" height="30"> <input type="text" class="text" onmouseover = "dropdownmenu(this, event, menu3, '200px')" name="orgName" value='Application Security Team'> </td>
	</tr>
		<tr bgcolor="D2E8FF">
		<td align="right" ><font size="2" color=" 004488" >Locality Name (LN) : </td>
		<td align="left" width="" height="30"> <input type="text" class="text" onmouseover = "dropdownmenu(this, event, menu4, '200px')" name="locName" value='Denver'> </td>
	</tr>
		<tr bgcolor="DFECFF">
		<td align="right" ><font size="2" color=" 004488" >State Name (SN) : </td>
		<td align="left" width="" height="30"> <input type="text" class="text" onmouseover = "dropdownmenu(this, event, menu5, '200px')" name="state" value='Colorado'> </td>
	</tr>
		<tr bgcolor="D2E8FF">
		<td align="right" ><font size="2" color=" 004488" >Country (C) : </td>
		<td align="left" width="" height="30"> <input type="text" class="text"  onmouseover = "dropdownmenu(this, event, menu6, '200px')" name="country" value='US'> </td>
	</tr>
	
		<tr bgcolor="DFECFF">
		<td align="right" ><font size="2" color=" 004488" >Email (E) : </td>
		<td align="left" width="" height="30"> <input type="text" class="text" onmouseover = "dropdownmenu(this, event, menu7, '200px')" name="email" value='certinfo@qwest.com'> </td>
	</tr>
	<tr bgcolor="D2E8FF">
	...
	<tr bgcolor="DFECFF">
		...
		<td align="left" width="" height="30"> <input type="text" class="text" name="pubKey"  disabled="disabled"> </td>
	</tr>
	<tr bgcolor="DFECFF">
		<td align="right" ><font size="2" color=" 004488" >Private Key :</td>
		<td align="left" width="" height="30"> <input type="text" class="text" name="priKey"  disabled="disabled"> </td>
	</tr>
 	</table>
	<table>
	<tr>
